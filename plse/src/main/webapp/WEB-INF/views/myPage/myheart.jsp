...
<script type="text/javascript">
 ...
 /* 좋아요 한 글 부르기  */    
     $(".myheart").click(function(){
    	 ...
    	 document.getElementById("review_heart").style.display = "block";
    	 $(".review_heart_btn").addClass( 'active' );
		myheart_list(1);   	 
	 });
     $(".review_heart_btn").click(function(){
    	 myheart_list(1);  	 
     });
     $(".recipe_heart_btn").click(function(){
    	 myheart_list(2);   	 
     });
  ...
  //좋아요 한 글
		//---------------------------------------------------------------
	     ...
	     //좋아요한 글 목록
	     function myheart_list(category){
	     	currentPage = 0; 
	      	
	    	var category =category; //카테고리 1,2
	     	var now = moment(); //현재시간
	               ...
	               if(data.length > 0){
	                   for(i=0; i<data.length; i++){
	                	  ...
	                	  if(category == 1){//리뷰 선택시
	                		  console.log("좋아요 리뷰 선택시 : "+ category);
		       	               if(comnum <1){
		                	 ...
		                	 //데이터 출력
	                		  ...
	                		  console.log("좋아요 레시피 선택시 : "+ category);
	                		  if(comnum <1){
...
<!-- 리뷰보기 / 레시피보기  -->
		...
		<ul class="list_select_ul">
			<li><button class="art_tablink active review_heart_btn" onclick="openArticle(event, 'review_heart')">리뷰</button></li>
			<li><button class="art_tablink recipe_heart_btn" onclick="openArticle(event, 'recipe_heart')">레시피</button></li>
		</ul>
	</div>	
	<!-- 리뷰보기 -->
	<article  id="review_heart" class="art_content" >
		<table class="table table-striped table-list  table-list-3 table-hover" style="width: 100%;">
				<thead>
					<tr height="42px">
	...
	<!-- 레시피 보기 -->
	<article  id="recipe_heart" class="art_content" >
	
		<table class="table table-striped table-list  table-list-4  table-hover" style="width: 100%;">
				<thead>
					<tr height="42px">
